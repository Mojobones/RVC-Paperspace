...
basev2: ## Download version 2 pre-trained models (Do only once after cloning the fork)
	...
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/blaise-tk/TITAN/resolve/main/models/medium/32k/pretrained/D-f032k-TITAN-Medium.pth -d assets/pretrained_v2 -o f0D32k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/blaise-tk/TITAN/resolve/main/models/medium/40k/pretrained/D-f040k-TITAN-Medium.pth -d assets/pretrained_v2 -o f0D40k.pth
	...
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/blaise-tk/TITAN/resolve/main/models/medium/32k/pretrained/G-f032k-TITAN-Medium.pth -d assets/pretrained_v2 -o f0G32k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/blaise-tk/TITAN/resolve/main/models/medium/40k/pretrained/G-f040k-TITAN-Medium.pth -d assets/pretrained_v2 -o f0G40k.pth
