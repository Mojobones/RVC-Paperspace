...
basev2: ## Download version 2 pre-trained models (Do only once after cloning the fork)
	...
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/D_KLMv7s_Batch3A_32k.pth -d assets/pretrained_v2 -o f0D32k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/D_KLMv7s_Batch3A_40k.pth -d assets/pretrained_v2 -o f0D40k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/D_KLMv7s_Batch3A_48k.pth -d assets/pretrained_v2 -o f0D48k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/G_KLMv7s_Batch3A_32k.pth -d assets/pretrained_v2 -o f0G32k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/G_KLMv7s_Batch3A_40k.pth -d assets/pretrained_v2 -o f0G40k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/SeoulStreamingStation/KLMv7s_Batch3/resolve/main/G_KLMv7s_Batch3A_48k.pth -d assets/pretrained_v2 -o f0G48k.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/uvr5_weights/HP2-人声vocals+非人声instrumentals.pth -d assets/uvr5_weights -o HP2-人声vocals+非人声instrumentals.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/uvr5_weights/HP5-主旋律人声vocals+其他instrumentals.pth -d assets/uvr5_weights -o HP5-主旋律人声vocals+其他instrumentals.pth
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/hubert_base.pt -d ./ -o assets/hubert/hubert_base.pt
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main/rmvpe.pt -d ./ -o assets/rmvpe/rmvpe.pt
