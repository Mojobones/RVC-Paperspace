    ...
    with gr.Tabs():
        ...
        with gr.TabItem(i18n("模型推理")):
            with gr.Row():
                ...
                ##############################################
                refresh_button = gr.Button(i18n("Refresh voice list, index path and audio files"), variant="primary") # M region1 beginning
                clean_button = gr.Button(i18n("卸载音色省显存"), variant="primary") # M region1 end
                spk_item = gr.Slider(
                    minimum=0,
                    maximum=2333,
                    step=1,
                ...
                with gr.Row():
                    with gr.Column():
                        ...
                        f0method0 = gr.Radio(
                            ...
                            choices=["pm", "harvest", "dio", "crepe", "mangio-crepe", "mangio-crepe-tiny", "rmvpe"],
                            value="rmvpe",
                            interactive=True,
                        )
